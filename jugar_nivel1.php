...
<body>
        ...
        if(!$row > 0){
            ...
            if($_SESSION["puntaje"]>=100){
                $_SESSION["id_p"]=20; 
            ?>
            
            <div class="contenedor2">
            <button class="boton" onclick="location.href='jugar_nivel2.php'" type="button">Siguiente Nivel</button>
            ...
            <div class="contenedor2">
            <button class="boton" onclick="location.href='jugar_nivel1.php'" type="button">Volver a intentar</button>
...
<div class="contenedor">
    ...
    <!--<p >Genero: </p> --> 
            <input class="resp" type="submit" value = "CIERTO" name="cierto">          
            <input class="resp" type="submit" value = "FALSO" name="falso">
</div>
</form>
...
<?php }
    ...
    if(isset($_POST['cierto'])){
        ...
        if($res==$row['respuesta']){
            ...
            <button class="siguiente" onclick="location.href='jugar_nivel1.php'" type="button">siguiente</button>
