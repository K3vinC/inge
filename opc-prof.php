...
<div class="container">
    <div class=" m-4 position-relative " style="height:500px;">
        <div class="bg-light shadow rounded border position-absolute top-50 start-50 translate-middle" style="width:450px;">
            <div class="card-header rounded-top">
                ...
                &nbsp; Menu, Bienvenido profesor.&nbsp;&nbsp;<i class="fas fa-chalkboard-teacher h5" style="color:gray;"></i>
            </div>
    ...
    clip-path: polygon(87% 0, 0 0, 0 100%, 87% 100%, 100% 51%);"><i class="fas fa-graduation-cap"></i>
                ...
                <button class="btn btn-secondary  btn-outline-light" type="button" style="border-radius: 5px;
    clip-path: polygon(87% 0, 0 0, 0 100%, 87% 100%, 100% 51%);"><i class="fas fa-pencil-ruler"></i>
                    &nbsp; Modificar Reglas</button>
                <button class="btn btn-secondary  btn-outline-light" type="button" style="border-radius: 5px;
