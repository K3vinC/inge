...
<head>
    ...
    <link rel="stylesheet" href="front-end/jugar_nivel3.css">
...
<?php   
        ...
        if(!$row > 0){
            ...
            <button class="boton" onclick="location.href='vista.php'" type="button">Finalizar</button>
            ...
            <?php
                ...
                $proceso = new Jugar();
                $val1=$proceso->Valor2Aleatorio();
                $val2=$proceso->Valor2Aleatorio();
                $val3=$proceso->Valor2Aleatorio();
...
<div class="contenedor">
    ...
    <!--<p >Genero: </p> --> 
    <p>Seleccionar la respuesta</p>
                <div class="caja">
                    <select name = "opcion" >
                    <option value="<?php echo $Arrayopcion[0]; ?>"><?php echo $Arrayopcion[0]; ?></option>
                    <option value="<?php echo $Arrayopcion[1]; ?>"><?php echo $Arrayopcion[1]; ?></option>
                    <option value="<?php echo $Arrayopcion[2]; ?>"><?php echo $Arrayopcion[2]; ?></option>
                    <option value="<?php echo $Arrayopcion[3]; ?>"><?php echo $Arrayopcion[3]; ?></option>
                    </select>
                </div> 
...
<?php }
    ...
    if(isset($_POST['enviar'])){
        ...
        if($res==$row['respuesta']){
            $_SESSION["puntaje"]=$_SESSION["puntaje"]+3;
            $_SESSION["id_p"]++;
            ?>
            <div name="form2" class="form2">
            <img src="front-end/imagenes/exito.png" width="120" height="120">
            <h2>La respuesta es Correcta</h2>
            <button class="siguiente" onclick="location.href='jugar_nivel3.php'" type="button">siguiente</button>
